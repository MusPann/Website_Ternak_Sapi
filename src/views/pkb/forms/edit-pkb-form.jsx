      ...
      >
        <Form {...formItemLayout}>
          ...
          <Form.Item label="NIK Peternak:">
            {getFieldDecorator("nikPeternak", { initialValue: nikPeternak })(
          ...
          <Form.Item label="Kategori:">
            {getFieldDecorator("kategori", {
              ...
              <Select style={{ width: 150 }}>
                <Select.Option value="Sapi Potong">Sapi Potong</Select.Option>
                <Select.Option value="Sapi Perah">Sapi Perah</Select.Option>
              </Select>
            )}
          </Form.Item>
